...
banner_url: https://raw.githubusercontent.com/MinhHuuNguyen/ai-lectures/refs/heads/master/2_data_analysis_with_python/images/3-matplotlib-seaborn/banner.png
tags: [python]
is_highlight: false
is_published: true
---
...
plt.ylabel('Sales')
plt.grid()
plt.savefig('monthly_sales.png')  # Lưu biểu đồ dưới dạng file PNG
plt.show()
```
